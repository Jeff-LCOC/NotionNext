...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JeffLuo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '不期而遇，天使然也', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-sandy-psi.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '一些记录', // 网站关键词 英文逗号隔开
