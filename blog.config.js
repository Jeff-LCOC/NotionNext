...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jeff Luo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-sandy-psi.vercel.app', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Jeff-LCOC', // 你的github个人主页 例如 https://github.com/tangly1024
